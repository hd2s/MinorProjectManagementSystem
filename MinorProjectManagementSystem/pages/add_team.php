...
<div class="panel panel-default">
	...
	<div class="col-md-4">
		<div class="form-group">
			<div class="col-sm-2"><label for="">SPOC:</label></div>
			<div class="col-sm-10">
			<select name="fid" id="" class="form-control chosen-select" data-placeholder="Select Student">
			<option></option>
				<?php
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
			<select name="mid" id="mid" class="form-control chosen-select" data-placeholder="Select Student">
			<option></option>
				<?php
