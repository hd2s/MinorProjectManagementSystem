...
<div class="col-md-11 col-md-offset-10">
	...
	<a class="col-sm-2 btn btn-md btn-info" href="#new_project" data-toggle="modal"><center><i class="fa fa-plus"></i> New Minor Project</center></a>
...
<br>
    ...
    <thead>
      <tr id="heads">
        <th class="col-md-2 text-center">Minor Project</th>
