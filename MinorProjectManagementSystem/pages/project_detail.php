...
<div class="panel-body">
	...
	<div class="row form-group">
		<label class="control-label" style="font-size:20px !important">Minor Project Name:</label>
	...
	<div class="row form-group">
		<label class="control-label">Estimated LOC:</label>
		<label class="control-label"><?php echo  $row['overall_cost'] . ' KLOC' ?></label>
	</div>
	
	<div class="row form-group">
		<label class="control-label">Minor Project SPOC:</label>
		<label class="control-label"><?php echo $row['name'] ?></label>
	</div>
	</div>
	<div class="col-md-6">
	<div class="row form-group">
		<label class="control-label">Minor Project Type:</label>
	...
	<?php } ?>
		<div class="row form-group">
		<label class="control-label">Project Modules:</label>
