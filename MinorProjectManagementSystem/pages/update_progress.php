...
<div class="panel-body">
	...
	<br>
	<div class="row">
		<div class="col-sm-4 text-right"><label class="control-label" style="font-size:15px !important">Minor Project Name:</label></div>
	...
	<div class="row">
		<div class="col-sm-4 text-right"><label class="control-label">Department:</label></div>
		<div class="col-sm-8 text-left"><label class="control-label"><?php echo $row['location'] ?></label></div>
	</div>

	<div class="row">
		<div class="col-sm-4 text-right"><label class="control-label">Estimated LOC:</label></div>
		<div class="col-sm-8 text-left"><label class="control-label"><?php echo  $row['overall_cost'] . ' KLOC' ?></label></div>
	</div>
	
	<div class="row">
		<div class="col-sm-4 text-right"><label class="control-label">Minor Project SPOC:</label></div>
		<div class="col-sm-8 text-left"><label class="control-label"><?php echo $row['name'] ?></label></div>
	</div>
	<div class="row">
		<div class="col-sm-4 text-right"><label class="control-label">Minor Project type:</label></div>
		...
		<div class="row">
		<div class="col-sm-4 text-right"><label class="control-label">Minor Project Status:</label></div>
...
<center>
	...
	<div class="row">
			...
			<div class="col-sm-4 text-right"><label for="" class="control-label">Module:</label></div>
			<div class="col-sm-8">
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				...
				<th class="col-sm-2 text-center">Module</th>
