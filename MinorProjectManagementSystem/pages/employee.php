...
<div class="col-lg-10">
    ...
    <thead>
      <tr id="heads">
        ...
        <th class="col-md-3 text-center">Student Name</th>
        <th class="col-md-2 text-center">Guide</th>
        <th class="col-md-1 text-center"></th>
      </tr>
    </thead>
    <tbody>
...
<div class="col-md-2">
	...
	<a class="col-sm-12 btn btn-md btn-info"  href="#new_employee" data-toggle="modal"><center><i class="fa fa-plus"></i>New Student</center></a>
</div>
<div id="retCode1"></div>
