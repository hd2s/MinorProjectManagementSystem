...
<div class="col-lg-8">
    ...
    <thead>
      <tr id="heads">
        ...
        <th class="col-md-2 text-center">Modules</th>
        <th class="col-md-1 text-center">Minor Project type</th>
        <th class="col-md-1 text-center"></th>
      </tr>
    </thead>
    <tbody>
...
<div class="col-md-4">
	...
	<br>
<div id="add_form">
	<h4 id="frm-title">New Module</h4>
	<hr style="border-bottom:1px solid grey"></hr>

	<form method="POST" id="pos_form">
		<div class="form-horizontal">
			<div class="form-group">
			<div class="col-sm-4"><label class="control-label" for="pos">Module:</label></div>
				<div class="col-sm-7">
			...
			<div class="col-sm-4"><label class="control-label" for="pos">Minor Project Type:</label></div>
				<div class="col-sm-7">
