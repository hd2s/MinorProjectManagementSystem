...
<div class="col-lg-8">
	<div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title"><strong>Guides</strong></h3>
        </div> 
    ...
    <thead>
      <tr id="heads">
        <th class="col-md-2 text-center">Guide Name</th>
        <th class="col-md-2 text-center">No. of Students</th>
    ...
    ?>
      <tr>
        ...
        <td style="text-transform:capitalize" class="text-center"><?php echo $row['daily_rate'].' students ' ?></td>
...
<div id="add_form">
	...
	<form method="POST" id="pos_form">
		<div class="form-horizontal">
			...
			<div class="col-sm-2"><label class="control-label" for="pos">Guide:</label></div>
				<div class="col-sm-7">
		...
		<div class="form-horizontal">
			<div class="form-group">
			<div class="col-sm-4"><label class="control-label" for="dr">No. of Students:</label></div>
				<div class="col-sm-5">
					<input type="number" style="text-align:right" class="form-control input-sm" name="dr" id="dr" placeholder="students" required/>
				</div>
			</div>
		</div>	
		<hr style="border-bottom:1px solid grey"></hr>
