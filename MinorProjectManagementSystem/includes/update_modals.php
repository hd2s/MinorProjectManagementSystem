 ...
 <div class="modal-body">
    ...
    <div class="form-horizontal">
      ...
      <div class="form-group" id="form-login">
          <label class="col-sm-4 control-label">Guide</label>
          <div class="col-sm-8">
        ...
        <div class="form-group" id="form-login">
          <label class="col-sm-4 control-label">Students</label>
          <div class="col-sm-8">
   ...
   $prow=mysqli_fetch_assoc($query_proj);
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group" id="form-login">
         ...
         <div class="form-group" id="form-login">
          <label class="col-sm-4 control-label">Proposed Minor Project:</label>
          <div class="col-sm-8">
          ...
          <option value="3">SDC</option>
          </select>
          </div>
        </div>
      <div class="form-group" id="form-login">
          <label class="col-sm-4 control-label">Minor Project Name:</label>
          <div class="col-sm-8">
      ...
      <div class="form-group" id="form-login">
          <label class="col-sm-4 control-label">Estimated LOC:</label>
          <div class="col-sm-6">
            <input class="form-control" style="text-align:right" id="cc" name="cost" type="text" placeholder="KLOC" value="<?php echo $prow['overall_cost'] ?>">
          </div>
        </div>
      ...
      <div class="form-group" id="form-login">
        ...
        <div class="form-group" id="form-login">
          <label class="col-sm-4 control-label">Minor Project SPOC:</label>
          <div class="col-sm-8">
